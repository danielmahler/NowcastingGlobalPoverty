...
here::i_am("01.code/03j.mi_lasso_poor_and_rich.R")
library(here)
library(glue)
library(data.table)
library(tidymodels)
...
if (run_LC) {
  ...
  readr::write_rds(LC, here("02.inputdata/mi/LC_ri_po.rds"))
  pushoverr::pushover("finish creating LC")

} else {

  LC <- readr::read_rds(here("02.inputdata/mi/LC_ri_po.rds"))
...
if (run_inner_tune) {
  ...
  readr::write_rds(inner_tune, here("02.inputdata/mi/inner_tune_ri_po.rds"))
  pushoverr::pushover("finish inner tuning")
} else {

  # inner_tune <- readr::read_rds(here("02.inputdata/mi/l_tuned_results.rds"))
  inner_tune <- readr::read_rds(here("02.inputdata/mi/inner_tune_ri_po.rds"))
...
if (run_outer_yhat) {
  ...
  readr::write_rds(outer_yhat, here("02.inputdata/mi/outer_yhat_ri_po.rds"))
  pushoverr::pushover("finish outer fold prediction")

} else {

  # inner_tune <- readr::read_rds(here("02.inputdata/mi/l_tuned_results.rds"))
  outer_yhat <- readr::read_rds(here("02.inputdata/mi/outer_yhat_ri_po.rds"))
}
...
if (run_imp_now) {
  ...
  readr::write_rds(imp_now, here("02.inputdata/mi/imp_now_ri_po.rds"))
  pushoverr::pushover("finish outer fold prediction")

} else {
  # inner_tune <- readr::read_rds(here("02.inputdata/mi/l_tuned_results.rds"))
  imp_now <- readr::read_rds(here("02.inputdata/mi/imp_now_ri_po.rds"))
}
...
readr::write_rds(orig_pred, here("02.inputdata/mi/pred_lasso_mi_ri_po.rds"))
haven::write_dta(orig_pred, here("02.inputdata/mi/pred_lasso_mi_ri_po.dta"))
haven::write_dta(orig_pred, here("03.intermediatedata/Predictions/lasso_ri_po.dta"))
